...
urlpatterns = [
    ...
    path('buy_all_decorations/', views.buy_all_decorations, name='buy_all_decorations'),
    path('payment_success1/', views.payment_success, name='payment_success'),  # Changed to payment_success1
    path('payment_failed/', views.payment_failed, name='payment_failed'),
    path('payment_success1/<str:order_id>/<str:payment_id>/', views.payment_success, name='payment_success'),
